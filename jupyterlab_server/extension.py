...
def load_jupyter_server_extension(nbapp):
    ...
    from jupyterlab_server.lab_handlers.build_handler import build_path, Builder, BuildHandler
    from jupyterlab_server.lab_handlers.extension_manager_handler import (
        extensions_handler_path, ExtensionManager, ExtensionHandler
    )
    from jupyterlab_server.lab_handlers.error_handler import ErrorHandler
    from .commands import (
